...
MASTER_PORT=29560
RUN_NAME="phase1_tp8pp3_seq65536_pdbs2_ga16_20260614"
export MASTER_PORT
...
exec python /tmp/submissions-instructions-runtime/src/train.py \
  ...
  --model_path /tmp/olmo3_phase1/model/allenai-Olmo-3.1-32B-Think \
  --dataset_path /groups/gcg51557/experiments/0371_aimo/containers/team1/train_phase_1.parquet \
  --output_path "/tmp/olmo3_phase1/outputs/${RUN_NAME}" \
  --logdir "/tmp/olmo3_phase1/logs/${RUN_NAME}" \
  --olmo_core_checkpoint_cache /tmp/olmo3_phase1/cache/olmo32b_core_checkpoint \
  --olmo_core_dataset_cache /tmp/olmo3_phase1/cache/olmo32b_phase1_seq65536 \
  --num_gpus 8 \
  ...
  --rank_microbatch_size_sequences 2 \
  --gradient_accumulation_steps 16 \
  --global_batch_size_tokens 2211840 \
